...
enum TAdventureObjectType : int32_t
{
    ...
    OBJECT_CREATURE_GENERATOR1         = 17,  // Внешнее жилище существ
    OBJECT_CREATURE_GENERATOR2         = 18,  //
    OBJECT_CREATURE_GENERATOR3         = 19,  //
    OBJECT_CREATURE_GENERATOR4         = 20,  // Конфлюкс элементалей и фабрика големов
    OBJECT_CURSED_GROUND_ROE           = 21,  // Проклятая земля (RoE)
    ...
    OBJECT_MAGIC_PLAINS_ROE            = 46,  // Магические равнины (RoE)
    ...
    OBJECT_CURSED_GROUND   = 223,             // Проклятая земля
    ...
    OBJECT_MAGIC_PLAINS    = 230,             // Магические равнины
    ...
    FIRST_NEW_AB_OBJECT    = TERRAIN_BRUSH2,
    LAST_NEW_AB_OBJECT     = OBJECT_TRADING_POST_SNOW,
    FIRST_NEW_SOD_OBJECT   = OBJECT_CLOVER_FIELD,
    LAST_NEW_SOD_OBJECT    = OBJECT_ROCKLANDS,
    FIRST_ADVENTURE_OBJECT = OBJECT_ALTAR_OF_SACRIFICE,
    LAST_ADVENTURE_OBJECT  = OBJECT_ROCKLANDS,
    FIRST_OBJECT_ROE       = FIRST_ADVENTURE_OBJECT,
    LAST_OBJECT_ROE        = OBJECT_RANDOM_MONSTER_L7
};
